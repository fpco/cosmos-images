...
### Taken from https://github.com/osmosis-labs/osmosis/blob/765f2b68fba64a7781ff81ed7919ef4d462b4d50/tests/localosmosis/scripts/setup.sh#L1
...
add_genesis_accounts () {
    ...
    osmosisd add-genesis-account osmo1ssnwszx2dutvlrpwwgefpfyswgrrm059d5mcfe 1000000000000uosmo,1000000000000uion,1000000000000stake,1000000000000uusdc,1000000000000uweth --home $OSMOSIS_HOME
